                    ...
                    <div className="space-y-6">
                            ...
                            {currentQuestion.options.map((option, index) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`flex items-center space-x-3 rounded-xl p-4 transition-all duration-300 text-left font-medium
                      ${showResult && isCorrectAnswer
                                    ...
                                    >
                                        ...
                                        {showResult && isCorrectAnswer && <span className="text-xl">✅</span>}
                                        {showResult && isWrongAnswer && <span className="text-xl">❌</span>}
                                    </button>
                                );
                            })}
                        </div>

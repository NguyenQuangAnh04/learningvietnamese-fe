...
const MultipleGameVoice: React.FC = () => {
    ...
    const speakText = (text: string) => {
        if ('speechSynthesis' in window) {
            ...
            utterance.lang = 'en-US'; // hoặc 'ja-JP' cho tiếng Nhật
                        ...
                        <div className="mt-10 p-6 bg-[#1b262c] rounded-lg text-center ">
                            ...
                            <div>
                                <button
                                    ...
                                    onClick={() => navigate(`/quiz/game/${gameId}/topic/${topicId}`)}
                                >
                                    Play again
                                </button>                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div className="mt-5 flex items-center justify-center flex-col space-y-2">
                            ...
                            <button
                                ...
                                className="flex items-center space-x-2 bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg transition-colors font-semibold"
                                title="Đọc câu hỏi"
                            >
...
export default MultipleGameVoice;

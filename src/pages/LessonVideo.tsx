        ...
        <div className='max-w-[1200px] mx-auto px-2 py-6'>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
              {/* Video Title */}
              <div className="mb-4">
                <h1 className="text-2xl font-bold mb-2">Basic Greetings - Video Lesson</h1>
                <p className="text-gray-300">Learn essential Vietnamese greetings with native pronunciation</p>
              </div>
              ...
              <div className="mt-6 bg-[#1b262c] p-6 rounded-lg">
                ...
                <p className="text-gray-300 leading-relaxed mb-4">
                  In this video lesson, you'll learn the most common Vietnamese greetings and how to use them in different situations.
                  Our native speaker will guide you through proper pronunciation and cultural context.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="text-white ml-2">8 phrases</span>
                  </div>
                  <div>
